...
module.exports = function (middleware, router, controllers) {
  ...
  router.get('/api/v1/common', apiCtrl.common.getCommonData)
  ...
  const apiOptional = middleware.apiOptional

  // Settings
  router.get('/api/v1/settings', apiOptional, apiCtrl.settings.getSettings)
