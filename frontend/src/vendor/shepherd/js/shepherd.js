...
})(typeof window !== 'undefined' ? window : this || {}, function (Tether) {
  /* global Tether */
    ...
    _createClass(Step, [
      ...
      },
      {
        ...
        value: function setOptions () {
          ...
          var buttonsAreEmpty =
            buttonsJson === '{}' || buttonsJson === '[]' || buttonsJson === 'null' || buttonsJson === 'false'
        ...
        value: function render () {
          ...
          this.el = createFromHTML(
            "<div class='shepherd-step " +
              ...
              this.id +
              "' " +
              (this.options.idAttribute ? 'id="' + this.options.idAttribute + '"' : '') +
              '></div>'
          )
            ...
            ;(function () {
              ...
              _this5.options.buttons.map(function (cfg) {
                var button = createFromHTML(
                  "<li><a class='shepherd-button " + (cfg.classes || '') + "'>" + cfg.text + '</a>'
                )
      ...
      },
      {
        ...
        value: function removeStep (name) {
          ...
          if (current && current.id === name) {
            ...
            if (this.steps.length) this.show(0)
            else this.hide()
          }
        }
      },
