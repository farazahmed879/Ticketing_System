    ...
    <div className="animate-fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <CustomSkeleton width="180px" height="1.5rem" />
          <div className="glass-card" style={{ padding: '20px' }}>
            <CustomSkeleton width="40%" height="1rem" style={{ marginBottom: '12px' }} />
            <CustomSkeleton width="80%" height="1.2rem" style={{ marginBottom: '8px' }} />
            <CustomSkeleton width="100%" height="3rem" style={{ marginBottom: '12px' }} />
            <CustomSkeleton width="30%" height="1rem" />
          </div>
        </div>
        <div className="glass-card" style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            <CustomSkeleton width="200px" height="1.5rem" />
            <CustomSkeleton width="60px" height="24px" borderRadius="12px" />
          </div>
          <div className="glass-card" style={{ padding: '16px', display: 'flex', alignItems: 'center', gap: '16px' }}>
            <CustomSkeleton width="50px" height="50px" borderRadius="12px" />
            <div style={{ flex: 1 }}>
              <CustomSkeleton width="120px" height="1.1rem" style={{ marginBottom: '6px' }} />
              <CustomSkeleton width="100px" height="0.9rem" />
            </div>
          </div>
          <CustomSkeleton width="100%" height="3rem" />
        </div>
      </div>
        ...
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="glass-card" style={{ padding: '24px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '16px' }}>
              <CustomSkeleton type="circle" width={24} height={24} />
              <CustomSkeleton type="circle" width={16} height={16} />
            </div>
            <CustomSkeleton width="60%" height="2rem" style={{ marginBottom: '8px' }} />
            <CustomSkeleton width="40%" height="1rem" />
          </div>
        ))}
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '24px' }}>
        <div>
          <div style={{ marginBottom: '24px' }}>
            <CustomSkeleton width="220px" height="1.5rem" />
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
             {Array.from({ length: 2 }).map((_, i) => (
                <div key={i} className="glass-card" style={{ padding: '20px' }}>
                   <CustomSkeleton width="100%" height="4rem" style={{ marginBottom: '20px' }} />
                   <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                      <CustomSkeleton type="circle" width={40} height={40} />
                      <div style={{ flex: 1 }}>
                         <CustomSkeleton width="60%" height="12px" style={{ marginBottom: '6px' }} />
                         <CustomSkeleton width="40%" height="10px" />
                      </div>
                   </div>
                </div>
        ...
        <div>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '20px' }}>
            <CustomSkeleton width="150px" height="1.5rem" />
            <CustomSkeleton width="100px" height="1.2rem" />
          </div>
          <div className="glass-card" style={{ padding: '20px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
            {Array.from({ length: 5 }).map((_, i) => (
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                <CustomSkeleton type="circle" width={24} height={24} />
                <div style={{ flex: 1 }}>
                  <CustomSkeleton width="70%" height="12px" style={{ marginBottom: '6px' }} />
                  <CustomSkeleton width="40%" height="10px" />
                </div>
