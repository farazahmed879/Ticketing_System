...
const AssigneeDropdownPartial = React.forwardRef((props, ref) => {
  const { ticketId, onClearClick, onAssigneeClick, socket } = props
  const [agents, setAgents] = React.useState([])

  const onUpdateAssigneeList = React.useCallback(data => {
    setAgents(data || [])
  }, [])
